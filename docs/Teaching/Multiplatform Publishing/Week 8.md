...
![Making the footnote refs more visible](../../../media/Screenshot_2022-03-15_at_10.47.57.png)
...
![Split the document on export](../../../media/Screenshot_2022-03-15_at_12.46.52.png)
...
![Export images settings](../../../media/Screenshot_2022-03-15_at_16.45.11.png)

> [!note] 
> Popup image enlargements only works on Apple Books; it does not work in Thorium nor Adobe Digital Editions.
...
> [!note] 
> The Apple Books software on MAC has recently been updated to behave the same as that version on the iOS devices, and that change means that the table of contents is no-longer a drop-down but rather a dedicated page seen alongside the cover image.
