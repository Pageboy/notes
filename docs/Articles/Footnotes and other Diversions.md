...
![Configuring footnotes in Adobe InDesign](indesignfootnotes.gif)
...
![footnotes have been transformed into side notes with a script](indesigntosidenotes.gif)
...
![Showing popup glossary in a Shakespeare text. _The Tempest_ CD-ROM, BBC/HarperCollins](tempest.gif)
...
![Popup information in an overlayed window](hypertextweb.gif)
...
![The link from the superscript number leads to the bottom of the web page](footnotessuperscript.gif)
...
![Here the link is set to the whole phrase rather than a reference number](footnotesrefisphrase.gif)
...
![Andrew Clark's web site](jquery_sidenotes.gif)
...
![This shows how tooltips look when hovering over with mouse](tooltips.gif)
...
![iBooks Author can produce popup glossary](popupgloss.gif)
...
![both glossary and popup notes](iba_gloss_poups.gif)
